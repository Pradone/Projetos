#Thats a "def" version of the original Jokenpo game that i made
...
def PPT():
    ...
    return "Até o próximo jogo!"



#deixar com uma linguagem mais amigável
#fazer alterações necessárias para melhorar o funcionamento com a IA